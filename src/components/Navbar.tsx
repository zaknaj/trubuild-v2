...
function ProjectsBreadcrumb() {
  ...
  const activeItemClass =
    "text-primary-lighter border-b border-primary-lighter/60 mt-1 pb-0.5"

  return (
    <div
      className={`rounded py-1.5 text-13 font-medium flex items-center gap-1.5 px-2.5 ${isActive ? "text-white" : "text-neutral-400"}`}
    >
...
export const Navbar = () => {
  return (
    <div className="h-13 shrink-0 flex items-center pl-9 pr-3 text-white justify-between bg-[#1E1E1E]">
      ...
      <div className="w-fit flex items-center gap-2 justify-center">
        <Link
          to="/"
          className="rounded py-1.5 text-13 font-medium flex items-center gap-1.5 px-2.5 border-[0.5px] border-transparent hover:bg-black/10 text-neutral-400"
          activeProps={{
